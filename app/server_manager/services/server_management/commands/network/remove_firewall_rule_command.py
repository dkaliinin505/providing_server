...
class RemoveFireWallRuleCommand(Command):
    ...
    async def execute(self, data):
        ...
        # Construct the ufw command to delete the rule
        ufw_command = f"sudo ufw delete {self.rule_type} {self.port}"
        ...
        return {
            "message": f"UFW rule deleted successfully. {self.rule_type.capitalize()} traffic on port {self.port} "
