...
class ServerManagementController(Controller):
    ...
    async def generate_deploy_key(self, data):
        ...
        return jsonify({"message": "Generate Deploy Key Task started in background", "task_id": task_id}, 200)
    ...
    async def delete_deploy_key(self, data):
        ...
        return jsonify({"message": "Delete Deploy Key Task started in background", "task_id": task_id}, 200)
    ...
    async def create_database(self, data):
        ...
        return jsonify({"message": "Create database started in background"}, 200)
    ...
    async def create_database_user(self, data):
        ...
        return jsonify({"message": "Create database User task started in background"}, 200)
    ...
    async def delete_database(self, data):
        ...
        return jsonify({"message": "Database delete task started in background"}, 200)
    ...
    async def delete_database_user(self, data):
        ...
        return jsonify({"message": "Delete database user task started in background"}, 200)
    ...
    async def update_database_user(self, data):
        ...
        return jsonify({"message": "Updated database user task started in background"}, 200)
